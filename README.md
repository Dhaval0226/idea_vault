...
Mark as favorite
📂 Project Structure
lib/ ├── models/ │ └── idea.dart ├── screens/ │ ├── login_screen.dart │ ├── home_screen.dart │ ├── idea_screen.dart │ └── profile_screen.dart ├── main.dart

📸 Screenshots
(Add your screenshots here)

Login Screen Home Screen - Bento Grid Idea Screen Profile Screen
...
✔ Local database implementation using Hive ✔ CRUD operations (Create, Read, Update, Delete) ✔ Dynamic UI with grid layout ✔ Form-based input handling ✔ Navigation between multiple screens ✔ Clean and responsive user interface
